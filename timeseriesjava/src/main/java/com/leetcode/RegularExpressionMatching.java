...
public class RegularExpressionMatching {
    ...
    public static void main(String[] args) {
        ...
        // Test recursive
        System.out.println("Recursive isMatch:");
        ...
        // Test DP
        System.out.println("\nDP matches:");
        System.out.println(rem.matches("aa", "a")); // false
        System.out.println(rem.matches("aa", "a*")); // true
        System.out.println(rem.matches("ab", ".*")); // true
        System.out.println(rem.matches("aab", "c*a*b")); // true
    }
}
